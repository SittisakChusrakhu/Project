    ...
    const drawer = (
        <div >
            ...
            <div>
                ...
                <ListItem disablePadding>
                    <ListItemButton href="/stu_report">
                        <ListItemIcon>
                            <AddAlert />
                        </ListItemIcon>
                        <ListItemText sx={{ color: '#FFFFFF' }} primary="แจ้งปัญหา" />
                    </ListItemButton>
                </ListItem>

                <ListItem disablePadding>
                    <ListItemButton href="/stu_listreport">
                        <ListItemIcon>
                            <Description />
                        </ListItemIcon>
                        <ListItemText sx={{ color: '#FFFFFF' }} primary="รายงานปัญหาของคุณ" />
                    </ListItemButton>
                </ListItem>
                <ListItem disablePadding>
                    <ListItemButton href="/stu_edit">
                        <ListItemIcon>
                            <Create />
                        </ListItemIcon>
